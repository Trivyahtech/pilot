            ...
            <div className="space-y-3">
              <div className="p-4 bg-white/10 rounded-lg hover:bg-white/15 transition-colors">
                <p className="text-gray-200 text-sm">
                  <span className="block text-white font-semibold">Tejas Turakhia</span>
                  {/* <span className="text-accent-300 font-medium">Marketing Manager</span><br /> */}
                  <a href="tel:918460740387" className="text-gray-300 hover:text-white transition-colors inline-flex items-center mt-1">
                    <Phone className="w-4 h-4 inline-block mr-1.5 text-accent-400" /> +91 8460740387
                  </a>
                </p>
              </div>
