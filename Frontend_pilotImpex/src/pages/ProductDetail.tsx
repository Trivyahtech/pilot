...
import caustic_soda_lye from "../assets/Pilot Impex Product Image/Caustic Soda Lye.webp";
import caustic_soda_flakes from "../assets/Pilot Impex Product Image/Caustic Soda Flakes.webp";
import hydrochloric_acid from "../assets/Pilot Impex Product Image/Hydrochloric Acid.webp";
import dilute_sulphuric_acid from "../assets/Pilot Impex Product Image/Dilute Sulphuric Acid.webp";
import sulphuric_acid from "../assets/Pilot Impex Product Image/Sulphuric Acid.webp";
import phosphoric_acid from "../assets/Pilot Impex Product Image/Phosphoric Acid.webp";
import caustic_potash_flakes from "../assets/Pilot Impex Product Image/Caustic Potash Flakes.webp";
import caustic_potash_lye from "../assets/Pilot Impex Product Image/Caustic Potash Lye.webp";
import caustic_soda_prill from "../assets/Pilot Impex Product Image/Caustic-Soda-Prills.webp";
import hydrogen_peroxide from "../assets/Pilot Impex Product Image/Hydrogen Peroxide.webp";
import aluminium_chloride from "../assets/Pilot Impex Product Image/Aluminium Chloride.webp";
import benzyl_chloride from "../assets/Pilot Impex Product Image/Benzyl Chloride.webp";
import sodium_chlorate from "../assets/Pilot Impex Product Image/Sodium Chlorate.webp";
import methylene_chloride from "../assets/Pilot Impex Product Image/Methylene Chloride MDC.webp";
import potassium_permanganate from "../assets/Pilot Impex Product Image/Potassium Permanganate.webp";
import hydrazine_hydrate from "../assets/Pilot Impex Product Image/Hydrazine Hydrate.webp";
import stable_bleaching_powder from "../assets/Pilot Impex Product Image/Stable Bleaching Powder.webp";
import chloroform from "../assets/Pilot Impex Product Image/Chloroform.webp";
import sodium_hypochlorite from "../assets/Pilot Impex Product Image/Sodium Hypochlorite.webp";
import poly_aluminium_chloride from "../assets/Pilot Impex Product Image/Poly Aluminium Chloride.webp";
import benzaldehyde from "../assets/Pilot Impex Product Image/Benzaldehyde.webp";
import chlorinated_paraffin from "../assets/Pilot Impex Product Image/Chlorinated Paraffin.webp";
import liquid_chlorine from "../assets/Pilot Impex Product Image/Liquid Chlorine.webp";
import benzyl_alcohol from "../assets/Pilot Impex Product Image/Benzyl Alcohol.webp";
import potassium_carbonate from "../assets/Pilot Impex Product Image/Potassium Carbonate.webp";
                ...
                <div className="space-y-6">
                  <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <Button 
                      ...
                      size="lg"
                      className="flex-1 bg-whatsapp hover:bg-whatsapp-dark text-white font-medium shadow-sm hover:shadow-md transition-all duration-200"
                    >
                      WhatsApp Inquiry
                      <ArrowRight className="ml-2 w-5 h-5" />
                    </Button>
